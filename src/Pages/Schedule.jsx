...
const Schedule = () => {
    ...
    piketGroup = [
        ["Kinan", "Frida", "Erni", "Hanun", "N Hana", "Rani", "Janez", "Tiara"],
        ["Angel", "Nsihah", "Gea", "Nabila", "Vnda", "Nimas", "Nufa"],
        ["Marlev", "Aurel", "Jagad", "  Yossha", "Nana", "Niki", "Shelly"],
        ["Anisa", "LYTA", "Jihan", "Desta", "Alisa", "Naura", "Hestu"],
        ["A hana", "ARTHA", "Nida", "Mila", "Nasywa", "Rihha", "Syahra"],
    ]
