...
import { imageStorage } from "../firebaseImage"; // gunakan storage untuk gambar
...
function UploadImage() {
	...
	const listImages = () => {
		const imageListRef = ref(imageStorage, "images/");
	...
	const uploadImage = () => {
		...
		const imageRef = ref(imageStorage, `images/${imageUpload.name}-${uuidv4()}`);
